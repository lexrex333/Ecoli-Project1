...
def run_trimmomatic(): 
    fastqs_dir= "/home/project1/Ecoli-Project1/Fastqs"
    output_dir= "/home/project1/Ecoli-Project1/Trimmomatic_Results"
   
    os.makedirs(output_dir, exist_ok=True) #make sure the output directory exsists                                    
    for file in os.listdir(fastqs_dir): #loop through each file in the fastqs directory
        if file.endswith(".fastq"):
            ...
            trimmed_fastq = os.path.join(output_dir, f"trimmed_{file}")
