...
def run_spades(read_dict):
    for key, value in read_dict.items():
        ...
        if value == "single":
            filename = f"Trimmomatictest_results/trimmed_{key}"+".fastq" #name of file containing reads for this genome
            ...
            file1 = f"Trimmomatictest_results/trimmed_{key}"+"_1.fastq" #names of files containing reads for this genome
            file2 = f"Trimmomatictest_results/trimmed_{key}"+"_2.fastq"
